...
//--Rev 	JRM Annand   27th May 2009  New class from HitCluster_t
...
//
//---------------------------------------------------------------------------
#ifndef __GenHitCluster_t_h__
#define __GenHitCluster_t_h__

#include "TMath.h"
#include "TVector3.h"
#include "EnumConst.h"

class TA2GenericCluster;

class GenHitCluster_t{
protected:
...
public:
  GenHitCluster_t( char*, UInt_t, Int_t = 1, Double_t = 0.0, Int_t = 0.0 );
  virtual ~GenHitCluster_t();
  virtual void ClusterDetermine( TA2GenericCluster* );
  virtual void Cleanup();
  virtual Bool_t IsNeighbour( UInt_t );
  virtual void MoreNeighbours( TA2GenericCluster* );
  virtual void Merge( GenHitCluster_t* );
  virtual Double_t OpeningAngle( GenHitCluster_t* );
  //
...
//---------------------------------------------------------------------------
inline void GenHitCluster_t::Cleanup()
{
...
//---------------------------------------------------------------------------
inline Bool_t GenHitCluster_t::IsNeighbour( UInt_t i )
{
...
//---------------------------------------------------------------------------
inline void GenHitCluster_t::Merge( GenHitCluster_t* cl )
{
...
//---------------------------------------------------------------------------
inline Double_t GenHitCluster_t::OpeningAngle( GenHitCluster_t* cl )
{
